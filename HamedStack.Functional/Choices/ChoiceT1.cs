...
public readonly struct Choice<T0, T1> : IChoice
{
    private readonly T0? _value0;
    private readonly T1? _value1;

    private Choice(int index, T0? value0 = default, T1? value1 = default)
    {
        Index = index;
        _value0 = value0;
        _value1 = value1;
    ...
    public static implicit operator Choice<T0, T1>(T0? t) => new(0, value0: t);
    public static implicit operator Choice<T0, T1>(T1? t) => new(1, value1: t);
    ...
    public static Choice<T0?, T1?> FromT0(T0? input) => input;
    public static Choice<T0?, T1?> FromT1(T1? input) => input;

        
    public Choice<TResult?, T1> MapT0<TResult>(Func<T0?, TResult?> mapFunc)
    {
    ...
    public Choice<T0, TResult?> MapT1<TResult>(Func<T1?, TResult?> mapFunc)
    {
        return mapFunc switch
        {
            null => throw new ArgumentNullException(nameof(mapFunc)),
    ...
    private bool Equals(Choice<T0, T1> other) =>
        Index == other.Index &&
        Index switch
        {
    ...
    public override bool Equals(object? obj)
    {
        ...
        {
            null => false,
            _ => obj is Choice<T0, T1> o && Equals(o)
        };
    }
