...
public class ChoiceBase<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> : IChoice
{
    ...
    protected ChoiceBase(Choice<T0?, T1?, T2?, T3?, T4?, T5?, T6?, T7?, T8?, T9?, T10?, T11?, T12?, T13?, T14?> input)
    {
        Index = input.Index;
        switch (Index)
        {
    ...
    private bool Equals(ChoiceBase<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> other) =>
        Index == other.Index &&
        Index switch
        {
    ...
    public override bool Equals(object? obj)
    {
        ...
        return obj is ChoiceBase<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> o && Equals(o);
    }
