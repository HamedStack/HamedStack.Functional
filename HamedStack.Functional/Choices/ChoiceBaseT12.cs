...
public class ChoiceBase<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> : IChoice
{
    ...
    protected ChoiceBase(Choice<T0?, T1?, T2?, T3?, T4?, T5?, T6?, T7?, T8?, T9?, T10?, T11?, T12?> input)
    {
        Index = input.Index;
        switch (Index)
        {
    ...
    private bool Equals(ChoiceBase<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> other) =>
        Index == other.Index &&
        Index switch
        {
    ...
    public override bool Equals(object? obj)
    {
        ...
        return obj is ChoiceBase<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> o && Equals(o);
    }
