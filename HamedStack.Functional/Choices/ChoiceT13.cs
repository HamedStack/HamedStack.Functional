...
public readonly struct Choice<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> : IChoice
{
    ...
    private Choice(int index, T0? value0 = default, T1? value1 = default, T2? value2 = default, T3? value3 = default, T4? value4 = default, T5? value5 = default, T6? value6 = default, T7? value7 = default, T8? value8 = default, T9? value9 = default, T10? value10 = default, T11? value11 = default, T12? value12 = default, T13? value13 = default)
    {
        Index = index;
        _value0 = value0;
        _value1 = value1;
    ...
    public static implicit operator Choice<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>(T0? t) => new(0, value0: t);
    public static implicit operator Choice<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>(T1? t) => new(1, value1: t);
    public static implicit operator Choice<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>(T2? t) => new(2, value2: t);
    public static implicit operator Choice<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>(T3? t) => new(3, value3: t);
    public static implicit operator Choice<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>(T4? t) => new(4, value4: t);
    public static implicit operator Choice<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>(T5? t) => new(5, value5: t);
    public static implicit operator Choice<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>(T6? t) => new(6, value6: t);
    public static implicit operator Choice<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>(T7? t) => new(7, value7: t);
    public static implicit operator Choice<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>(T8? t) => new(8, value8: t);
    public static implicit operator Choice<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>(T9? t) => new(9, value9: t);
    public static implicit operator Choice<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>(T10? t) => new(10, value10: t);
    public static implicit operator Choice<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>(T11? t) => new(11, value11: t);
    public static implicit operator Choice<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>(T12? t) => new(12, value12: t);
    public static implicit operator Choice<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>(T13? t) => new(13, value13: t);
    ...
    public static Choice<T0?, T1?, T2?, T3?, T4?, T5?, T6?, T7?, T8?, T9?, T10?, T11?, T12?, T13?> FromT0(T0? input) => input;
    public static Choice<T0?, T1?, T2?, T3?, T4?, T5?, T6?, T7?, T8?, T9?, T10?, T11?, T12?, T13?> FromT1(T1? input) => input;
    public static Choice<T0?, T1?, T2?, T3?, T4?, T5?, T6?, T7?, T8?, T9?, T10?, T11?, T12?, T13?> FromT2(T2? input) => input;
    public static Choice<T0?, T1?, T2?, T3?, T4?, T5?, T6?, T7?, T8?, T9?, T10?, T11?, T12?, T13?> FromT3(T3? input) => input;
    public static Choice<T0?, T1?, T2?, T3?, T4?, T5?, T6?, T7?, T8?, T9?, T10?, T11?, T12?, T13?> FromT4(T4? input) => input;
    public static Choice<T0?, T1?, T2?, T3?, T4?, T5?, T6?, T7?, T8?, T9?, T10?, T11?, T12?, T13?> FromT5(T5? input) => input;
    public static Choice<T0?, T1?, T2?, T3?, T4?, T5?, T6?, T7?, T8?, T9?, T10?, T11?, T12?, T13?> FromT6(T6? input) => input;
    public static Choice<T0?, T1?, T2?, T3?, T4?, T5?, T6?, T7?, T8?, T9?, T10?, T11?, T12?, T13?> FromT7(T7? input) => input;
    public static Choice<T0?, T1?, T2?, T3?, T4?, T5?, T6?, T7?, T8?, T9?, T10?, T11?, T12?, T13?> FromT8(T8? input) => input;
    public static Choice<T0?, T1?, T2?, T3?, T4?, T5?, T6?, T7?, T8?, T9?, T10?, T11?, T12?, T13?> FromT9(T9? input) => input;
    public static Choice<T0?, T1?, T2?, T3?, T4?, T5?, T6?, T7?, T8?, T9?, T10?, T11?, T12?, T13?> FromT10(T10? input) => input;
    public static Choice<T0?, T1?, T2?, T3?, T4?, T5?, T6?, T7?, T8?, T9?, T10?, T11?, T12?, T13?> FromT11(T11? input) => input;
    public static Choice<T0?, T1?, T2?, T3?, T4?, T5?, T6?, T7?, T8?, T9?, T10?, T11?, T12?, T13?> FromT12(T12? input) => input;
    public static Choice<T0?, T1?, T2?, T3?, T4?, T5?, T6?, T7?, T8?, T9?, T10?, T11?, T12?, T13?> FromT13(T13? input) => input;

        
    public Choice<TResult?, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> MapT0<TResult>(Func<T0?, TResult?> mapFunc)
    {
    ...
    public Choice<T0, TResult?, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> MapT1<TResult>(Func<T1?, TResult?> mapFunc)
    {
        return mapFunc switch
        {
            null => throw new ArgumentNullException(nameof(mapFunc)),
    ...
    public Choice<T0, T1, TResult?, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> MapT2<TResult>(Func<T2?, TResult?> mapFunc)
    {
        return mapFunc switch
        {
            null => throw new ArgumentNullException(nameof(mapFunc)),
    ...
    public Choice<T0, T1, T2, TResult?, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> MapT3<TResult>(Func<T3?, TResult?> mapFunc)
    {
        return mapFunc switch
        {
            null => throw new ArgumentNullException(nameof(mapFunc)),
    ...
    public Choice<T0, T1, T2, T3, TResult?, T5, T6, T7, T8, T9, T10, T11, T12, T13> MapT4<TResult>(Func<T4?, TResult?> mapFunc)
    {
        return mapFunc switch
        {
            null => throw new ArgumentNullException(nameof(mapFunc)),
    ...
    public Choice<T0, T1, T2, T3, T4, TResult?, T6, T7, T8, T9, T10, T11, T12, T13> MapT5<TResult>(Func<T5?, TResult?> mapFunc)
    {
        return mapFunc switch
        {
            null => throw new ArgumentNullException(nameof(mapFunc)),
    ...
    public Choice<T0, T1, T2, T3, T4, T5, TResult?, T7, T8, T9, T10, T11, T12, T13> MapT6<TResult>(Func<T6?, TResult?> mapFunc)
    {
        return mapFunc switch
        {
            null => throw new ArgumentNullException(nameof(mapFunc)),
    ...
    public Choice<T0, T1, T2, T3, T4, T5, T6, TResult?, T8, T9, T10, T11, T12, T13> MapT7<TResult>(Func<T7?, TResult?> mapFunc)
    {
        return mapFunc switch
        {
            null => throw new ArgumentNullException(nameof(mapFunc)),
    ...
    public Choice<T0, T1, T2, T3, T4, T5, T6, T7, TResult?, T9, T10, T11, T12, T13> MapT8<TResult>(Func<T8?, TResult?> mapFunc)
    {
        return mapFunc switch
        {
            null => throw new ArgumentNullException(nameof(mapFunc)),
    ...
    public Choice<T0, T1, T2, T3, T4, T5, T6, T7, T8, TResult?, T10, T11, T12, T13> MapT9<TResult>(Func<T9?, TResult?> mapFunc)
    {
        return mapFunc switch
        {
            null => throw new ArgumentNullException(nameof(mapFunc)),
    ...
    public Choice<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult?, T11, T12, T13> MapT10<TResult>(Func<T10?, TResult?> mapFunc)
    {
        return mapFunc switch
        {
            null => throw new ArgumentNullException(nameof(mapFunc)),
    ...
    public Choice<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TResult?, T12, T13> MapT11<TResult>(Func<T11?, TResult?> mapFunc)
    {
        return mapFunc switch
        {
            null => throw new ArgumentNullException(nameof(mapFunc)),
    ...
    public Choice<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TResult?, T13> MapT12<TResult>(Func<T12?, TResult?> mapFunc)
    {
        return mapFunc switch
        {
            null => throw new ArgumentNullException(nameof(mapFunc)),
    ...
    public Choice<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult?> MapT13<TResult>(Func<T13?, TResult?> mapFunc)
    {
        return mapFunc switch
        {
            null => throw new ArgumentNullException(nameof(mapFunc)),
    ...
    private bool Equals(Choice<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> other) =>
        Index == other.Index &&
        Index switch
        {
    ...
    public override bool Equals(object? obj)
    {
        ...
        {
            null => false,
            _ => obj is Choice<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> o && Equals(o)
        };
    }
