...
public readonly struct Choice<T0, T1, T2, T3> : IChoice
{
    ...
    private Choice(int index, T0? value0 = default, T1? value1 = default, T2? value2 = default, T3? value3 = default)
    {
        Index = index;
        _value0 = value0;
        _value1 = value1;
    ...
    public static implicit operator Choice<T0, T1, T2, T3>(T0? t) => new(0, value0: t);
    public static implicit operator Choice<T0, T1, T2, T3>(T1? t) => new(1, value1: t);
    public static implicit operator Choice<T0, T1, T2, T3>(T2? t) => new(2, value2: t);
    public static implicit operator Choice<T0, T1, T2, T3>(T3? t) => new(3, value3: t);
    ...
    public static Choice<T0?, T1?, T2?, T3?> FromT0(T0? input) => input;
    public static Choice<T0?, T1?, T2?, T3?> FromT1(T1? input) => input;
    public static Choice<T0?, T1?, T2?, T3?> FromT2(T2? input) => input;
    public static Choice<T0?, T1?, T2?, T3?> FromT3(T3? input) => input;

        
    public Choice<TResult?, T1, T2, T3> MapT0<TResult>(Func<T0?, TResult?> mapFunc)
    {
    ...
    public Choice<T0, TResult?, T2, T3> MapT1<TResult>(Func<T1?, TResult?> mapFunc)
    {
        return mapFunc switch
        {
            null => throw new ArgumentNullException(nameof(mapFunc)),
    ...
    public Choice<T0, T1, TResult?, T3> MapT2<TResult>(Func<T2?, TResult?> mapFunc)
    {
        return mapFunc switch
        {
            null => throw new ArgumentNullException(nameof(mapFunc)),
    ...
    public Choice<T0, T1, T2, TResult?> MapT3<TResult>(Func<T3?, TResult?> mapFunc)
    {
        return mapFunc switch
        {
            null => throw new ArgumentNullException(nameof(mapFunc)),
    ...
    private bool Equals(Choice<T0, T1, T2, T3> other) =>
        Index == other.Index &&
        Index switch
        {
    ...
    public override bool Equals(object? obj)
    {
        ...
        {
            null => false,
            _ => obj is Choice<T0, T1, T2, T3> o && Equals(o)
        };
    }
