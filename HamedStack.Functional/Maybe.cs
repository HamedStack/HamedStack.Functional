...
public readonly struct Maybe<T> : IEquatable<Maybe<T>>
{
    ...
    public static Maybe<(T, TOther)> Zip<TOther>(Maybe<T> maybe1, Maybe<TOther> maybe2)
    {
        if (maybe1.IsJust && maybe2.IsJust)
        {
            return Maybe<(T, TOther)>.Just((maybe1._value!, maybe2._value!));
        }
